...
export default function ChatInbox() {
    return (
        <div className='mx-4 text-left flex flex-col mt-6 '>
            ...
            <div className='bg-green-300 w-1/2  py-2 rounded-bl-xl rounded-tl-xl rounded-tr-xl pl-2 mt-2 self-end items-stretch' >Hey.</div>
            ...
            <div className="flex gap-2 ">
                <div className='bg-green-100 size-3 rounded-full pl-2 mt-2 animate-bounce' ></div>
                <div className='bg-green-100 size-3 rounded-full pl-2 mt-2 animate-bounce' ></div>
                <div className='bg-green-100 size-3 rounded-full pl-2 mt-2 animate-bounce' ></div>
            </div>
